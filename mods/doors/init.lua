...
for i = 1, #colours, 1 do
    doors.register_trapdoor("doors:trapdoor_"..colours[i][1], {
        description = colours[i][2].." Trapdoor",
        tile_front = "doors_trapdoor_steel.png^[colorize:" .. colours[i][3],
        tile_side = "doors_trapdoor_steel_side.png^[colorize:" .. colours[i][3],
        groups = {choppy = 2, snappy = 2, oddly_breakable_by_hand = 2, door = 1},
    })
end
